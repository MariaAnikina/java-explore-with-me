...
import ru.practicum.ewm.location.controller.LocationPublicController;
...
@WebMvcTest(controllers = LocationPublicController.class)
@RequiredArgsConstructor(onConstructor_ = @Autowired)
public class LocationPublicControllerTest {
    @MockBean
